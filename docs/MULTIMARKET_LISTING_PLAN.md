...
- **Salvation Army sync:** Automatic fetches now archive invoices + won items, log to `SalvationArmySyncLog`, and can be triggered via API or CRON. Future work: convert fetched HTML to structured invoices and auto-create purchases end-to-end.
